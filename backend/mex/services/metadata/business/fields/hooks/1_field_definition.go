...
type FieldDefinitionHooks map[string]fields.LifecycleFieldDefinitionHook

type FieldDefinitionHooksConfig struct {
	DB *pgxpool.Pool
}

func NewFieldDefinitionHooks(cfg FieldDefinitionHooksConfig) (FieldDefinitionHooks, error) {
	hooks := make(FieldDefinitionHooks)
...
func (hooks FieldDefinitionHooks) GetHook(fieldKind string) fields.LifecycleFieldDefinitionHook {

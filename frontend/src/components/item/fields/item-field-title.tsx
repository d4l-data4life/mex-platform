...
@Component({
  tag: 'mex-item-field-title',
  styleUrl: 'item-field.css',
})
export class ItemFieldTitleComponent {
  @Prop() field: Field;
  @Prop() item?: Item;
  ...
  render() {
    ...
    return (
      <Host class="item-field item-field--title">
        <h3 class={`item-field__value u-highlight ${isDiffHighlighted ? 'u-highlight-2' : ''}`} lang={lang}>
